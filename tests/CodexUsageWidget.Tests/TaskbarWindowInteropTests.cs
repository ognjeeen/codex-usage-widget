...
public sealed class TaskbarWindowInteropTests
{
    ...
    public void CalculatesPositionAcrossTheUsableWorkArea()
    {
        ...
        var topLeft = TaskbarWindowInterop.CalculateWorkAreaPosition(
            workArea, 200, 50, 0, new IndicatorPosition(0, 0), verticalMaximum: 800);
        var bottomRight = TaskbarWindowInterop.CalculateWorkAreaPosition(
            workArea, 200, 50, 0, new IndicatorPosition(100, 100), verticalMaximum: 800);
        var middle = TaskbarWindowInterop.CalculateWorkAreaPosition(
            workArea, 200, 50, 0, new IndicatorPosition(50, 50), verticalMaximum: 800);

        Assert.Equal(new System.Drawing.Point(100, 200), topLeft);
        Assert.Equal(new System.Drawing.Point(900, 800), bottomRight);
        Assert.Equal(new System.Drawing.Point(500, 500), middle);
    }
